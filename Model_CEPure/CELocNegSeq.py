...
#           and the location in the paper by negative sequence
#
# -------------------------------------------------------------------------------
...
class CELocNegSeq:
    ...
    def rank_weight_loc_negseq(self, ceopt=default_ceopt):
        ...
        ce_sidlst.sort()   # The difference with CELocPosSeq is that we do not reversely sort it
...
def TestCELocNegSeq():
    ...
    model = CELocNegSeq(pkfp1, ceopt="mance")
    topksent = 10
